...
const MobileMenu = () => {
  ...
  return (
    ...
    >
      <div className="bg-white border-none  md:border-4 border-gray-400 w-full h-full relative overflow-hidden px-3 shadow-2xl py-10 rounded-2xl max-sm:rounded-none">
        <div
